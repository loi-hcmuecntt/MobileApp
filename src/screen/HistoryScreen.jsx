...
import { Searchbar, IconButton, MD3Colors, Badge, Button} from 'react-native-paper';
    ...
    <ScrollView contentContainerStyle={{ 
      ...
      <View style={styles.container}>
        ...
        <Searchbar
          ...
          clearIcon={()=><Ionicons name="color-filter-outline" color="#000" size={20}/>}
          ...
          orders.map((order, index) => (
            ...
            >
              ...
              <View style={styles.cardaction}>
                ...
                <Button icon="map-marker-circle" mode="text" compact={true} color={MD3Colors.blue500}>
                  Track
                </Button>
              </View>
            </TouchableOpacity>
