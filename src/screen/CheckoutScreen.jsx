    ...
    <ScrollView contentContainerStyle={{ 
      ...
      <View style={styles.container}>
        ...
        <View style={styles.card}>
          <Text style={{fontSize:20, fontWeight:'bold', color: '#3C4048', marginBottom:10} }>Đơn hàng</Text>
          {
            cart.map((item, index) => (
              <TouchableOpacity key={index} style={styles.minicard}>
                ...
                <View style={styles.minicarddetails}>
                  ...
                  <Text style={{fontSize:15, fontWeight:'bold', color: '#3C4048', marginLeft:5}}>{item.quantity+' x '+item.price} VND</Text>
                </View>
              </TouchableOpacity>
            ))
          }
