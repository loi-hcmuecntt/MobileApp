              ...
              <View style={styles.carddetails}>
                ...
                >
                  <MaterialCommunityIcons 
                    ...
                    size={15}
                  />
                  <Text style={{fontSize:20, fontWeight:'bold', color: MD3Colors.black500, marginLeft:5} }>{order.name}</Text>
                </View>
                ...
                >
                  <Ionicons 
                    ...
                    size={15}
                  />
                  <Text style={{fontSize:15, color: MD3Colors.blue500, marginLeft:5} }>{order.quantity}</Text>
                </View>
